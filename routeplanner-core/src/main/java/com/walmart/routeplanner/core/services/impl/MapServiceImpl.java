...
public class MapServiceImpl implements MapService {
    ...
    /*
     * (non-Javadoc)
     * @see com.walmart.routeplanner.core.services.MapService#createPoints(com.walmart.routeplanner.core.model.entity.MapInfo)
     */
    @Override
    @Transactional
    ...
    /*
     * (non-Javadoc)
     * @see com.walmart.routeplanner.core.services.MapService#createRoutes(com.walmart.routeplanner.core.model.entity.MapInfo, int, int)
     */
    @Override
    @Transactional
